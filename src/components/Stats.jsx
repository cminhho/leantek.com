      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12">
          {stats.slice(0, 4).map((stat, index) => (
            <div key={index} className="bg-[#2A2A2A] p-6 sm:p-8 lg:p-12 xl:p-16">
              <h3 className="text-3xl sm:text-3xl lg:text-6xl font-light text-white mb-2">{stat.value}</h3>
              <p className="text-sm sm:text-sm text-gray-400 font-light">{stat.description}</p>
            </div>
          ))}
        </div>
        ...
        <div className="text-gray-400 space-y-4 sm:space-y-6 max-w-4xl">
          <p className="text-xs lg:text-base font-light leading-relaxed">
